...
import com.mvc.ttpay_android.bean.KLineBean;
...
import com.mvc.ttpay_android.view.PopMarkerView;
...
import static com.mvc.ttpay_android.common.Constant.SP.RECORDING_UNIT;

public class TrandRecordingFragment extends BaseActivity implements View.OnClickListener {
...
//        recording_current_tv
        ...
        dataSetByIndex.setFillDrawable(ContextCompat.getDrawable(TrandRecordingFragment.this, R.drawable.shape_linechart_fill));
