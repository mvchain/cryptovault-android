...
//        Glide.with(mContext).load(item.)
        ...
        helper.setText(R.id.toge_histroy_pay_num, item.getSuccessPayed() + "/" + TextUtils.doubleToFour(item.getPrice()) + " VRT");
        helper.setText(R.id.toge_histroy_success_num, item.getSuccessPayed() + "/" + item.getValue() + " " + item.getTokenName());
