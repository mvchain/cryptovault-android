...
public class PswText extends AppCompatEditText {
    // 画笔
    ...
    private PswMaxListener maxListener;

    public void setMaxListener(PswMaxListener maxListener) {
    ...
    private void drawHidePassword(Canvas canvas) {
        ...
        if(passwordLength == 6){
            maxListener.maxPsw(getText().toString());
        }
    }
